...
echo "        <br>  ";
echo "        <input type='submit' name='popo' value='borrarcuenta'><input type='submit' name='popo' value='Modificar'>";
echo "        </form>";
?>
